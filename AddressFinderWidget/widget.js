...
! function(e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.AddressFinder = t() : e.AddressFinder = t(); }(window, function() {
    return function(e) {
        ...
        return r.m = e, r.c = t, r.d = function(e, t, n) { r.o(e, t) || Object.defineProperty(e, t, { enumerable: !0, get: n }); }, r.r = function(e) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e, "__esModule", { value: !0 }); }, r.t = function(e, t) {
            ...
            return n;
        }, r.n = function(e) { var t = e && e.__esModule ? function() { return e["default"]; } : function() { return e; }; return r.d(t, "a", t), t; }, r.o = function(e, t) { return Object.prototype.hasOwnProperty.call(e, t); }, r.p = "", r(r.s = 13);
    }([function(e, t, r) {
        var n;
        (function() {
            var i = [].slice,
            ...
            void 0 === (n = function() {
                return (e = {}).VERSION = "1.6.1", e.addDomEvent = function(e, t, r) { var n; return e.addEventListener ? e.addEventListener(t, r, !1) : (n = function() { return r.apply(e, arguments); }, e.attachEvent("on" + t, n)); }, e.removeDomEvent = function(e, t, r) { e.removeEventListener ? e.removeEventListener(t, r, !1) : e.detachEvent && e.detachEvent("on" + t, null); }, e.addClass = function(t, r) { return e.classNameExists(t, r) || (r = " " + r, t.className += r), t; }, e.removeClass = function(e, t) {
                    ...
                    if (null == this)
                        throw new TypeError;
                    if (i = Object(this), 0 == (r = i.length >>> 0))
                        return -1;
                    if (n = 0, arguments.length > 0 && ((n = Number(arguments[1])) != n ? n = 0 : 0 !== n && Infinity !== n && -Infinity !== n && (n = (n > 0 || -1) * Math.floor(Math.abs(n)))), n >= r)
                        return -1;
                    ...
                    function e() {}
                    return e.prototype.setOption = function(e, t) { return this.options[e] = t, this; }, e.prototype.getOption = function(e) { return this.options[e]; }, e.prototype.on = function(e, t) { var r; return null == this.subs && (this.subs = {}), null == (r = this.subs)[e] && (r[e] = []), this.subs[e].push(t), this; }, e.prototype.trigger = function() {
                        var e, t, r, n, s, o;
                        if (t = arguments[0], e = 2 <= arguments.length ? i.call(arguments, 1) : [], null != (null != (s = this.subs) ? s[t] : void 0))
                            for (r = 0, n = (o = this.subs[t]).length; r < n; r++)
                                o[r].apply(this, e);
                        return this;
                    }, e;
                }(), e.Widget = function(t) {
                    function r(e, t) { this.element = e, this.options = null != t ? t : {}, this._onPaste = s(this._onPaste, this), this._onBlur = s(this._onBlur, this), this._onKeyDown = s(this._onKeyDown, this), this._onKeyPress = s(this._onKeyPress, this), this._onFocus = s(this._onFocus, this), this._triggerEnabledEvent = s(this._triggerEnabledEvent, this), this.enable = s(this.enable, this), this.disable = s(this.disable, this), this.enable(), this.searchQueued = !1, this.element.getAttribute("autocomplete") || this.element.setAttribute("autocomplete", "off"), this.services = [], this._applyDefaults(), null == this.getOption("container") && this.setOption("container", window.document.body), this._addListeners(), this.output = document.createElement("ul"), this.output.className = this.options.list_class, this._applyStyle("display", "none"), this._applyStyle("position", this.options.position), this.options.container.appendChild(this.output); }
                    return o(r, t), r.prototype.defaults = { max_results: 10, list_class: "nc_list", item_class: "nc_item", hover_class: "nc_hover", footer_class: "nc_footer", empty_class: "nc_empty", error_class: "nc_error", icon_class: "nc_icon", hidden_icon_class: "nc_hidden", position: "absolute", timeout: 400, ignore_returns: !0 }, r.prototype.addService = function(t, r, n) { var i; return null == n && (n = {}), this.services.push(i = new e.Service(this, t, r, n)), i; }, r.prototype.disable = function() { return this.enabled = !1, this.icon && e.addClass(this.icon, this.options.hidden_icon_class), this.output.innerHTML = "", e.removeDomEvent(this.element, "enabled", this.disable), this; }, r.prototype.enable = function() { return this.enabled = !0, this.icon && e.removeClass(this.icon, this.options.hidden_icon_class), this.enableDelay && clearTimeout(this.enableDelay), this.enableDelay = setTimeout(this._triggerEnabledEvent, 500), this; }, r.prototype.destroy = function() { document.body.removeChild(this.output), this.element.removeAttribute("autocomplete"), this.icon && (document.body.removeChild(this.icon), window.removeEventListener("resize", this._resetIconPosition)); }, r.prototype._triggerEnabledEvent = function() {
                        if (this.enabled)
                            return e.removeDomEvent(this.element, "enabled", this.disable), this._dispatchDOMEvent("enabled"), e.addDomEvent(this.element, "enabled", this.disable);
                    }, r.prototype._applyDefaults = function() {
                        var e, t, r, n;
                        for (e in r = [], t = this.defaults)
                            n = t[e], null == this.getOption(e) ? r.push(this.setOption(e, n)) : r.push(void 0);
                        return r;
                    }, r.prototype._addListeners = function() { return e.addDomEvent(this.element, "focus", this._onFocus), e.addDomEvent(this.element, "keypress", this._onKeyPress), e.addDomEvent(this.element, "keydown", this._onKeyDown), e.addDomEvent(this.element, "blur", this._onBlur), e.addDomEvent(this.element, "paste", this._onPaste); }, r.prototype._removeListeners = function() { return e.removeDomEvent(this.element, "focus", this._onFocus), e.removeDomEvent(this.element, "keypress", this._onKeyPress), e.removeDomEvent(this.element, "keydown", this._onKeyDown), e.removeDomEvent(this.element, "blur", this._onBlur), e.removeDomEvent(this.element, "paste", this._onPaste); }, r.prototype._onFocus = function(e) { return this.focused = !0; }, r.prototype._onKeyPress = function(e) {
                        var t, r, n;
                        if (r = e.which || e.keyCode, this.visible && 13 === r)
                            return null != (n = this.highlighted) && n.selectItem(), (t = this.getOption("ignore_returns")) && e.preventDefault ? e.preventDefault() : t && (e.returnValue = !1), this.highlighted = null;
                    ...
                    }, r.prototype._onPaste = function(e) { return this._getSuggestionsWithTimeout(); }, r.prototype._moveHighlight = function(e) { var t, r, n, i; return t = null != this.highlighted ? this.results.indexOf(this.highlighted) : -1, null != (n = this.highlighted) && n.unhighlight(), (t += e) < -1 ? t = this.results.length - 1 : t >= this.results.length && (t = -1), null != (i = this.results[t]) && i.highlight(), r = void 0 !== this._val ? this._val : "", this.element.value = null != this.highlighted ? this.highlighted.value : r; }, r.prototype._getSuggestionsWithTimeout = function() { return null != this._timeout && clearTimeout(this._timeout), this._timeout = setTimeout((e = this, function() { return e._getSuggestions(); }), this.options.timeout); var e; }, r.prototype._getSuggestions = function() {
                        var e, t, r, n, i;
                        if (this.enabled) {
                    ...
                    }, r.prototype.selectHighlighted = function() { this.element.value = this.highlighted.value, this._hideResults(), this.trigger("result:select", this.highlighted.value, this.highlighted.data), this._dispatchDOMEvent("change"); }, r.prototype._dispatchDOMEvent = function(e) {
                        var t;
                    ...
                    function t(e, t) { var r, n, i, s;
                        this.service = e, this.options = t, this.widget = this.service.widget, this.renderer = this.service.options.renderer || this.widget.options.renderer, this.value = null != (r = this.options) ? r.value : void 0, this.score = (null != (n = this.options) ? n.score : void 0) || 0, this.identifier = null != (i = this.options) ? i.identifier : void 0, this.data = (null != (s = this.options) ? s.data : void 0) || {}; } return t.prototype.render = function() { return this.li = document.createElement("li"), this.li.innerHTML = null != this.renderer ? this.renderer(this.value, this.data) : this.value, this.li.className = this.widget.options.item_class, this.addEvents(), this.li; }, t.prototype.addEvents = function() { var t; return e.addDomEvent(this.li, "click", (t = this, function(e) { return t.selectItem(), e.preventDefault ? e.preventDefault() : e.returnValue = !1; })), e.addDomEvent(this.li, "mouseover", function(e) { return function() { return e.highlight(); }; }(this)), e.addDomEvent(this.li, "mouseout", function(e) { return function() { return e.unhighlight(); }; }(this)), e.addDomEvent(this.li, "mousedown", function(e) { return function() { return e.widget.mouseDownOnSelect = !0; }; }(this)), e.addDomEvent(this.li, "mouseup", function(e) { return function() { return e.widget.mouseDownOnSelect = !1; }; }(this)); }, t.prototype.selectItem = function() { return this.service.trigger("result:select", this.value, this.data), this.widget.highlighted = this, this.widget.selectHighlighted(); }, t.prototype.highlight = function() { var e; return null != (e = this.widget.highlighted) && e.unhighlight(), this.li.className = this.li.className + " " + this.widget.options.hover_class, this.widget.highlighted = this; }, t.prototype.unhighlight = function() { return this.widget.highlighted = null, this.li.className = this.li.className.replace(new RegExp(this.widget.options.hover_class, "gi"), ""); }, t; }(), e;
                var e;
            }.call(t, r, t, e)) || (e.exports = n);
        }).call(this);
    }, function(module, exports) { window.JSON || (window.JSON = { parse: function(sJSON) { return eval("(" + sJSON + ")"); } }); }, function(module, exports, __webpack_require__) {
        ...
        definition = function() {
            ...
            function succeed(e) { var t = protocolRe.exec(e.url); return t = t && t[1] || context.location.protocol, httpsRe.test(t) ? twoHundo.test(e.request.status) : !!e.request.response; }

            function handleReadyState(e, t, r) { return function() { return e._aborted ? r(e.request) : e._timedOut ? r(e.request, "Request is aborted: timeout") : void(e.request && 4 == e.request[readyState] && (e.request.onreadystatechange = noop, succeed(e) ? t(e.request) : r(e.request))); }; }
            ...
            function setHeaders(e, t) {
                ...
                for (r in t.crossOrigin || n[requestedWith] || (n[requestedWith] = defaultHeaders.requestedWith), n[contentType] || i || (n[contentType] = t.contentType || defaultHeaders.contentType), n)
            ...
            function generalCallback(e) { lastValue = e; }
            ...
            function handleJsonp(e, t, r, n) {
                ...
                }, head.appendChild(l), { abort: function() { l.onload = l.onreadystatechange = null, r({}, "Request is aborted: timeout", {}), lastValue = void 0, head.removeChild(l), c = 1; } };
            }

            function getRequest(e, t) { var r, n = this.o,
                    ...
                    a = !1; return "jsonp" != n.type && "GET" != i || !o || (s = urlappend(s, o), o = null), "jsonp" == n.type ? handleJsonp(n, e, t, s) : ((r = n.xhr && n.xhr(n) || xhr(n)).open(i, s, !1 !== n.async), setHeaders(r, n), setCredentials(r, n), context[xDomainRequest] && r instanceof context[xDomainRequest] ? (r.onload = e, r.onerror = t, r.onprogress = function() {}, a = !0) : r.onreadystatechange = handleReadyState(this, e, t), n.before && n.before(r), a ? setTimeout(function() { r.send(o); }, 200) : r.send(o), r); }

            function Reqwest(e, t) { this.o = e, this.fn = t, init.apply(this, arguments); }
            ...
            function init(o, fn) {
                ...
                function error(e, t, r) {
                    for (e = self.request, self._responseArgs.resp = e, self._responseArgs.msg = t, self._responseArgs.t = r, self._erred = !0; self._errorHandlers.length > 0;)
            ...
            function serial(e, t) {
                var r, n, i, s, o = e.name,
                    a = e.tagName.toLowerCase(),
                    u = function(e) { e && !e.disabled && t(o, normalize(e.attributes.value && e.attributes.value.specified ? e.value : e.text)); };
                if (!e.disabled && o)
                    switch (a) {
                        case "input":
            ...
            function eachFormElement() {
                ...
                for (t = 0; t < arguments.length; t++)
                    e = arguments[t], /input|select|textarea/i.test(e.tagName) && serial(e, r), n(e, ["input", "select", "textarea"]);
            }

            function serializeQueryString() { return reqwest.toQueryString(reqwest.serializeArray.apply(null, arguments)); }

            function serializeHash() { var e = {}; return eachFormElement.apply(function(t, r) { t in e ? (e[t] && !isArray(e[t]) && (e[t] = [e[t]]), e[t].push(r)) : e[t] = r; }, arguments), e; }
            ...
            return Reqwest.prototype = { abort: function() { this._aborted = !0, this.request.abort(); }, retry: function() { init.call(this, this.o, this.fn); }, then: function(e, t) { return e = e || function() {}, t = t || function() {}, this._fulfilled ? this._responseArgs.resp = e(this._responseArgs.resp) : this._erred ? t(this._responseArgs.resp, this._responseArgs.msg, this._responseArgs.t) : (this._fulfillmentHandlers.push(e), this._errorHandlers.push(t)), this; }, always: function(e) { return this._fulfilled || this._erred ? e(this._responseArgs.resp) : this._completeHandlers.push(e), this; }, fail: function(e) { return this._erred ? e(this._responseArgs.resp, this._responseArgs.msg, this._responseArgs.t) : this._errorHandlers.push(e), this; }, "catch": function(e) { return this.fail(e); } }, reqwest.serializeArray = function() { var e = []; return eachFormElement.apply(function(t, r) { e.push({ name: t, value: r }); }, arguments), e; }, reqwest.serialize = function() {
    ...
    }, function(e, t) { Object.create || (Object.create = function(e) { var t = function() {}; return t.prototype = e, new t; }); }, function(e, t) {
        Function.prototype.bind || (Function.prototype.bind = function(e) {
            ...
            var t = Array.prototype.slice.call(arguments, 1),
                r = this,
                n = function() {},
                i = function() { return r.apply(this instanceof n && e ? this : e, t.concat(Array.prototype.slice.call(arguments))); };
            return n.prototype = this.prototype, i.prototype = new n, i;
        });
    }, function(e, t) { e.exports = XMLHttpRequest; }, , , , , function(e, t, r) {}, , , function(e, t, r) {
        "use strict";
        r.r(t);
        r(1), r(3), r(4);
        var n = r(0),
            ...
            l = function(e) { console && console.error(e); },
            c = function(e, t) {
                if (t) {
        ...
        var d = function() { return null == window.XMLHttpRequest ? "jsonp" : null == (new XMLHttpRequest).withCredentials ? "jsonp" : "json"; },
            h = function() {
                for (var e = [], t = 0; t < 256;)
        ...
        var w = function(e) {
            ...
            function n(t, r) {
                var n;
                return b(v(n = e.call(this, t, r) || this), "record_id", function() { return n.data[n.service.identifierAttribute]; }), b(v(n), "selectItem", function() {
            ...
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n.prototype.selectItemSuccess = function(e) { this.data = e, this.widget.highlighted = this, this.widget.selectHighlighted(), this.service.trigger("result:select", this.value, this.data), this.widget.info_loading = !1, this.widget.highlighted = null; }, n;
        }(i.a._Result);
        ...
        var E = function(e) {
                ...
                function n() {
                    for (var t, r = arguments.length, n = new Array(r), i = 0; i < r; i++)
                        n[i] = arguments[i];
                    return R(A(t = e.call.apply(e, [this].concat(n)) || this), "populateValue", function() { return t.value = t.data.a; }), R(A(t), "selectItem", function() {
                    ...
                    }), R(A(t), "selectItemSuccess", function(r) { t.widget.getOption("allow_null_suburb") && r.city === r.suburb && (r.suburb = null), t.populateSelectedDataValues(r), e.prototype.selectItemSuccess.call(A(t), r); }), t;
                }
        ...
        var I = function(e) {
            ...
            function n(t, r) {
                var n;
                return void 0 === r && (r = {}), x(O(n = e.call(this) || this), "ready", function() { return n._ready; }), x(O(n), "_lockSearchRequests", function() { n._ready = !1, n._resume_requests_timer = setTimeout(function() { return n._ready = !0; }, m.MAX_QUERY_TIME); }), x(O(n), "_unlockSearchRequests", function() { n._resume_requests_timer && clearTimeout(n._resume_requests_timer), n._ready = !0; }), x(O(n), "search", function(e) {
                ...
                }), x(O(n), "searchError", function(e) { var t = JSON.parse(e.response);
                    n.widget.error_content = "\"Error:\n      <a href='" + n.widget.country.brochureUrl() + "/docs/address_autocomplete_api/#error_" + t.error_code + "' target='_blank'>\n        " + t.message + '\n      </a>"', n._unlockSearchRequests(), n.widget.showResults(); }), x(O(n), "searchSuccess", function(e) {
        ...
        var q = function(e) {
            ...
            function n(t, r) {
                var n;
                return void 0 === r && (r = {}), P(k(n = e.call(this, t, r) || this), "highlightRenderer", function(e, t) { return t.highlighted_a; }), P(k(n), "extraParams", function() {
                    if (n.widget.getOption("address_params"))
                        return S(n.widget.getOption("address_params"));
                }), P(k(n), "createResult", function(e, t) { return new E(e, t); }), n.on("result:select:pre", function(e, t) { return n.widget.trigger("address:select:pre", e, t); }), n.on("result:select", function(e, t) { return n.widget.trigger("address:select", e, t); }), "1" !== n.widget.getOption("address_params").highlight && 1 !== n.widget.getOption("address_params").highlight || (n.options.renderer = n.highlightRenderer), n.autocompleteURL = n.widget.getOption("base_url") + "/api/nz/address", n.infoURL = n.widget.getOption("base_url") + "/api/nz/address/info", n;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(I);
        ...
        var C = function(e) {
            ...
            function n() {
                for (var t, r, n, i, s = arguments.length, o = new Array(s), a = 0; a < s; a++)
                    o[a] = arguments[a];
                return t = e.call.apply(e, [this].concat(o)) || this, r = function(e) {
                    if (void 0 === e)
                        throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                    return e;
                }(t), i = function() { return t.value = t.data.a; }, (n = "populateValue") in r ? Object.defineProperty(r, n, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : r[n] = i, t;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(w);
        ...
        var T = function(e, t) {
            var r = this;
            j(this, "queryElements", function() { return r.queryString.match(/[a-z0-9]+/gi); }), j(this, "populateMask", function() {
            ...
            }), j(this, "format", function() { return r.populateMask(), r.applyMask(), r.highlightedAddress; }), this.fullAddress = e, this.queryString = t;
        };
        ...
        var L = function(e) {
            ...
            function n(t, r) {
                var n;
                return void 0 === r && (r = {}), N(H(n = e.call(this, t, r) || this), "highlightRenderer", function(e, t) { return void 0 === t.highlighted_a ? new T(e, n.last_query).format() : t.highlighted_a; }), N(H(n), "extraParams", function() {
                    if (n.widget.getOption("location_params"))
                        return S(n.widget.getOption("location_params"));
                }), N(H(n), "createResult", function(e, t) { return new C(e, t); }), n.on("result:select:pre", function(e, t) { return n.widget.trigger("location:select:pre", e, t); }), n.on("result:select", function(e, t) { return n.widget.trigger("location:select", e, t); }), "1" !== n.widget.getOption("location_params").highlight && 1 !== n.widget.getOption("location_params").highlight || (n.options.renderer = n.highlightRenderer), n.autocompleteURL = n.widget.getOption("base_url") + "/api/nz/location", n.infoURL = n.widget.getOption("base_url") + "/api/nz/location/info", n;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(I);
            ...
            function n() {
                ...
                return t = e.call.apply(e, [this].concat(o)) || this, r = function(e) {
                    if (void 0 === e)
                        throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
                    return e;
                }(t), i = function() { return t.value = t.data.name_and_address; }, (n = "populateValue") in r ? Object.defineProperty(r, n, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : r[n] = i, t;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(w);
        ...
        var V = function(e) {
            ...
            function n(t, r) {
                var n;
                return void 0 === r && (r = {}), U(z(n = e.call(this, t, r) || this), "highlightRenderer", function(e, t) { return t.highlighted_name_and_address; }), U(z(n), "extraParams", function() {
                    if (n.widget.getOption("points_of_interest_params"))
                        return S(n.widget.getOption("points_of_interest_params"));
                }), U(z(n), "createResult", function(e, t) { return new F(e, t); }), n.on("result:select:pre", function(e, t) { return n.widget.trigger("points_of_interest:select:pre", e, t); }), n.on("result:select", function(e, t) { return n.widget.trigger("points_of_interest:select", e, t); }), "1" !== n.widget.getOption("points_of_interest_params").highlight && 1 !== n.widget.getOption("points_of_interest_params").highlight || (n.options.renderer = n.highlightRenderer), n.autocompleteURL = n.widget.getOption("base_url") + "/api/nz/points_of_interest", n.infoURL = n.widget.getOption("base_url") + "/api/nz/points_of_interest/info", n;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(I);
        ...
        var K = function(e) {
            ...
            function n() {
                for (var t, r = arguments.length, n = new Array(r), i = 0; i < r; i++)
                    n[i] = arguments[i];
                return X(B(t = e.call.apply(e, [this].concat(n)) || this), "populateValue", function() { return t.value = t.data.a; }), X(B(t), "record_id", function() { return t.data[t.service.identifierAttribute]; }), X(B(t), "selectItem", function() {
                    if (t.data && t.data[t.service.identifierAttribute] && !t.widget.info_loading) {
                        var e;
                        t.widget.info_loading = !0, t.populateValue(), t.service.trigger("result:select:pre", t.value, t.data);
                        var r = ((e = { format: "json", key: t.widget.api_key, wv: m.WIDGET_VERSION, session: t.widget.sessionID })[t.service.identifierAttribute] = t.record_id(), e);
                ...
                }), X(B(t), "selectItemSuccess", function(e) { t.data = e, t.service.trigger("result:select", t.value, t.data), t.widget.highlighted = B(t), t.widget.selectHighlighted(), t.widget.info_loading = !1, t.widget.highlighted = null; }), t;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(w);
        ...
        var Y = function(e) {
            ...
            function n(t, r) {
                var n;
                return void 0 === r && (r = {}), Q(G(n = e.call(this, t, r) || this), "search", function(e) { return n._unlockSearchRequests(); }), Q(G(n), "showNearbyIcon", function() {
                    if (n.widget.enabled)
                        return i.a.removeClass(n.widget.icon, "af_hidden");
                }), Q(G(n), "hideNearbyIcon", function() { return i.a.addClass(n.widget.icon, "af_hidden"); }), Q(G(n), "keyPressHandler", function(e) { var t = e.which || e.keyCode,
                        r = String.fromCharCode(t); return "" === n.widget.element.value ? n.showNearbyIcon() : n.nearbyResultsFound ? /[a-z0-9]/i.test(r) ? (n.widget.element.blur(), n.widget.element.focus(), n.nearbySearchInProgress = !1, n.nearbyResultsFound = !1, n.hideNearbyIcon()) : void 0 : n.hideNearbyIcon(); }), Q(G(n), "changeHandler", function() { return "" === n.widget.element.value ? n.showNearbyIcon() : n.hideNearbyIcon(); }), Q(G(n), "iconClicked", function() {
                ...
                }), Q(G(n), "initNearbySearch", function() { var e = { "class": "af_info_panel", cancellable: !0, cancelHandler: n.cancelNearbySearch, persistant: !1 };
                    n.widget.setInfoPanel("Requesting your GPS coordinates", e); }), Q(G(n), "nearbySearchTimeout", function() {
                    if (n.nearbySearchInProgress) {
                ...
                }), Q(G(n), "nearbySearchError", function(e) { clearTimeout(n.initSearchTimeout), n.cancelNearbySearch(); var t = { "class": "af_info_panel", cancellable: !0, cancelHandler: n.cancelNearbySearch, persistant: !1 };
                    n.widget.setInfoPanel("We weren't able to access the address. Please check your GPS services are turned on, or enter an address into the search bar above.", t); }), Q(G(n), "cancelNearbySearch", function() { clearTimeout(n.searchTimeout), i.a.removeClass(n.widget.icon, "active"), n.nearbySearchInProgress = !1; }), Q(G(n), "getNearbyAddress", function(e) { var t = S({ x: e.longitude, y: e.latitude, key: n.widget.api_key, max: n.widget.options.max_results, wv: m.WIDGET_VERSION, session: n.widget.sessionID }); return n.widget.reqwest({ url: n.autocompleteURL + "?" + t, success: n.getNearbyAddressSuccess }); }), Q(G(n), "getNearbyAddressSuccess", function(e) {
                    if (n.nearbySearchInProgress) {
                ...
                }), Q(G(n), "createResult", function(e, t) { return new K(e, t); }), Q(G(n), "queryReverseGeocodeAPI", function(e, t) { return console.log("Querying: " + e + ", " + t); }), Q(G(n), "_applyDefaults", function() {
                    for (var e in n.defaults)
                        n.getOption(e) || n.setOption(e, n.defaults[e]);
                }), n.widget = t, n.options = r, n._applyDefaults(), n.widget.options.show_nearby && (n.widget.element.addEventListener("change", function() { return setTimeout(n.changeHandler, 100); }), n.widget.element.addEventListener("keyup", n.keyPressHandler), n.widget.setIcon({ "class": n.options.icon_class }, n.iconClicked)), n.results = [], n.nearbySearchInProgress = !1, n.nearbyResultsFound = !1, n.autocompleteURL = n.widget.getOption("base_url") + "/api/nz/address/nearby", n.infoURL = n.widget.getOption("base_url") + "/api/nz/address/info", n;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(I);
        ...
        var ne = function(e) {
            ...
            function n(t, r) {
                var n;
                return void 0 === r && (r = {}), re(te(n = e.call(this, t, r) || this), "highlightRenderer", function(e, t) { return t.highlighted_full_address; }), re(te(n), "extraParams", function() {
                    if (n.widget.getOption("address_params"))
                        return S(n.widget.getOption("address_params"));
                }), re(te(n), "createResult", function(e, t) { return new ee(e, t); }), "1" !== n.widget.getOption("address_params").highlight && 1 !== n.widget.getOption("address_params").highlight || (n.options.renderer = n.highlightRenderer), n.on("result:select:pre", function(e, t) { return n.widget.trigger("address:select:pre", e, t); }), n.on("result:select", function(e, t) { return n.widget.trigger("address:select", e, t); }), n.autocompleteURL = n.widget.getOption("base_url") + "/api/au/address/autocomplete", n.infoURL = n.widget.getOption("base_url") + "/api/au/address/info", n;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(I);
        ...
        var ae = function(e) {
            ...
            function n() {
                for (var t, r = arguments.length, n = new Array(r), i = 0; i < r; i++)
                    n[i] = arguments[i];
                return oe(se(t = e.call.apply(e, [this].concat(n)) || this), "record_id", function() { return t.data.id; }), oe(se(t), "populateValue", function() { return t.value = t.data.full_location; }), oe(se(t), "selectItemSuccess", function(r) { return t.value = r.full_location, e.prototype.selectItemSuccess.call(se(t), r); }), t;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(w);
        ...
        var ce = function(e) {
            ...
            function n(t, r) {
                var n;
                return void 0 === r && (r = {}), le(ue(n = e.call(this, t, r) || this), "highlightRenderer", function(e, t) { return t.highlighted_full_location; }), le(ue(n), "extraParams", function() {
                    if (n.widget.getOption("location_params"))
                        return S(n.widget.getOption("location_params"));
                }), le(ue(n), "createResult", function(e, t) { return new ae(e, t); }), "1" !== n.widget.getOption("location_params").highlight && 1 !== n.widget.getOption("location_params").highlight || (n.options.renderer = n.highlightRenderer), n.on("result:select:pre", function(e, t) { return n.widget.trigger("location:select:pre", e, t); }), n.on("result:select", function(e, t) { return n.widget.trigger("location:select", e, t); }), n.autocompleteURL = n.widget.getOption("base_url") + "/api/au/location", n.infoURL = n.widget.getOption("base_url") + "/api/au/location/info", n;
            }
            return r = e, (t = n).prototype = Object.create(r.prototype), t.prototype.constructor = t, t.__proto__ = r, n;
        }(I);
        ...
        var ge = { element: { presence: !0, name: "Input element" }, api_key: { presence: !0 }, country_code: { presence: !0, inclusion: ["AU", "au", "NZ", "nz"] }, "options.container": { presence: !0, name: "Option 'container'" } },
            ye = function(e) {
                var t, r;
        ...
        var me, ve = ye,
            ...
            we = function(e, t) { return function() { return e.apply(t, arguments); }; },
